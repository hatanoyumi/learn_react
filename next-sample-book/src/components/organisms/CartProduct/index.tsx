...
import Link from "next/link"; // パラメータ付きのnext/linkを使用するときは、hrefに/product/${id}を指定する必要がある
  ...
  return (
    <Flex justifyContent="space-between">
      ...
      <Box display={{ base: 'none', md: 'block' }}>
        {/* 削除ボタン（デスクトップ） */}
        <RemoveText color="danger" onClick={() => onRemoveButtonClick && onRemoveButtonClick(id)}>カートから削除</RemoveText>
      </Box>
    </Flex>
  )
}
