...
const SearchPage: NextPage = () => {
  ...
  // 商品の状態をクエリから取得
   ...
   return (
    <Layout>
      <Box paddingLeft={{ base: 2, md: 3 }} paddingRight={{ base: 2, md: 3 }} paddingTop={2} paddingBottom={2}>
        <Box marginBottom={1}>
          <Breadcrumb>
            <BreadcrumbItem>
              <Link href="/"><a>トップス</a></Link>
            </BreadcrumbItem>
            <BreadcrumbItem>
              <Link href="/search"><a>検索</a></Link>
            </BreadcrumbItem>
            {/* パンクズリストを選択したカテゴリから生成 */}
        ...
        <Flex>
          <Flex flexDirection={{ base: 'column', md: 'row' }}>
            ...
            <Box>
              ...
              {/* 商品カードリストコンテナ。検索クエリから商品カードリストを表示 */}
              <ProductCardListContainer category={slug.length > 0? slug[slug.length -1] : undefined} condition={conditions} />
            </Box>
          </Flex>
        </Flex>
      </Box>
