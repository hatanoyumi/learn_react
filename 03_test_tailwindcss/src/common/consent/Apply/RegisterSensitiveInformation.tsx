...
const RegisterSensitiveInformation = ({ className }: ConsentProps) => {
  return (
    <div className={clsx('text-gs-black', className)}>
      <p className={content}>NHN은 지원자의 동의를 받아 NHN 계열법인에 민감정보를 제공합니다.</p>
...
export default RegisterSensitiveInformation;
